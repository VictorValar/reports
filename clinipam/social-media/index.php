...
<section id="greyband">
	<section class="top">
		<h2 font-style: italic>Pautas e Conteúdos de Social Media</h2>

	</section>

<!-- Report -->
	<section class="content boxgrey">
		<section class="bottom">
			<iframe width="100%" height="900" src="https://datastudio.google.com/embed/reporting/1FB47WKrC9Ykt-Wqp2xzTZwAhzfibQf_S/page/sVww" frameborder="0" style="border:0" allowfullscreen></iframe>
...
<link rel="shortcut icon" href="http://3wpublicidade.com.br/wp-content/themes/3wpublicidade/imagens/favicon.png" type="image/x-icon">
	...
	<link href="http://3wpublicidade.com.br/wp-content/themes/3wpublicidade/css/style.css" rel="stylesheet" type="text/css">
...
<script type="text/javascript" src="http://3wpublicidade.com.br/wp-includes/js/wp-embed.min.js?ver=4.9.10"></script>
